          ...
          if(is_array($users) && sizeof($users)>0){
            foreach ($users as $key => $value) {
              ...
              <tr>
                ...
                <td>
                  <button type="button" name="id-obj" value="" class="btn btn-warning <?php if($value->getId()== $_SESSION['user']->getId()){
                    echo 'disabled';} ?>" data-toggle="modal" data-target="#makeAdmin<?= $value->getId();?>">
                    Hacer Administrador
                  </button>
                </td>
                <!-- MAKE ADMIN Modal -->
              ...
              <td>
                <button type="button" name="id-obj" value="" class="btn btn-warning <?php if($value->getId()== $_SESSION['user']->getId()){
                    echo 'disabled';} ?>" data-toggle="modal" data-target="#makeClient<?= $value->getId();?>">
                  Hacer Cliente
                </button>
              </td>
              <!-- MAKE CLIENT Modal -->
            ...
            <?php  } ?>
              <?php if($value->getRole()->getId() != 3){ ?>
                <td>
                  <button type="button"  name="id-obj" value="" class="btn btn-danger <?php if($value->getId()== $_SESSION['user']->getId()){
                    echo 'disabled';} ?>" data-toggle="modal" data-target="#unsuscribe<?= $value->getId();?>">
                    Dar de Baja
                  </button>
                </td>
              </tr>
